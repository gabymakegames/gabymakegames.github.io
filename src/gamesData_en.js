const gamesData_en = {
    ...
    Jreverse: {
      ...
      description:
        `A puzzle–platformer where the floor itself decides your direction!
...
Can you find the smartest way to reach the end?`,
    ...
    infinityInvaders: {
      ...
      description:
        `A classic 80’s-style space shooter — simple, fast, and addictive!
    ...
    pushme: {
      ...
      description:
        `Explore 3 unique worlds, each with its own look and vibe:
          • Paper World – Light and fragile, just like your wings.
          • Wall World – Urban streets filled with graffiti and attitude.
          • Jeans World – Denim textures and cozy chaos.
...
Every jump counts — can you reach the end with the fewest moves possible?

Featuring 4 unique game modes:
• Levels – Explore and master each stage at your own pace.
• Time – Race against the clock.
• Life – Limited chances, endless tension.
• Classic – Pure arcade fun, no distractions.
...
Simple controls, addictive gameplay, and a nostalgic pixel-art vibe — this is gravity, flipped.`,
    ...
    next: {
      ...
      description:
        "Let’s just say — we’ve got plenty of fresh ideas ahead.",
